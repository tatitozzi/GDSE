...
if(isset($_REQUEST["proceed"]))
{
	...
	(
		...
		"New Order",
		"Ordered items: ".stripslashes($_REQUEST["produtos_list"])."\n\n".
		"Total value: ".$xml_config->configuration->currency_symbol.$_REQUEST["produtos_value"]
	);
	...
	$paypal_link .= "item_name=".urlencode($_REQUEST["produtos_list"])."&";
	$paypal_link .= "amount=".$_REQUEST["produtos_value"];
