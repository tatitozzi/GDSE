 ...
 * http://www.apache.org/licenses/LICENSE-2.0 */ 
 ?>
 <link href="netart-xml-cart/css/main.css" rel="stylesheet"/> <div id="cart-container">
	<div class="col-md-7">
		...
		if(file_exists("netart-xml-cart/produtos.xml"))
		{
			$file="netart-xml-cart/produtos.xml";
		}
		else
		{
		...
		//Loop through the produtos defined in the products.xml file
		...
		<br/><br/>
		 <div class="panel panel-default cart-panel">
			<div class="panel-heading">
				<img class="pull-left add-right-margin" height="20" src="netart-xml-cart/images/cart-m.png"/>
...
<div id="payment-container">
	...
	<form id="payment-from" action="netart-xml-cart/process_order.php" target="ajax-ifr">
	...
	?>
		...
		<img src="netart-xml-cart/images/paypal.png" alt="Payment through PayPal.com"/>
	<?php
	}
...
<iframe id="ajax-ifr" name="ajax-ifr" src="netart-xml-cart/empty.html" class="no-visibility" width="1" height="1"> </iframe>

<script src="netart-xml-cart/js/netart-xml-cart.js"></script>
